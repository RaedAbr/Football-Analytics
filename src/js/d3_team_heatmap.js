...
// const ratio = wonHTMLPanel.width() / defaultWidth;
// const lostSvgRatio = lostHTMLPanel.width() / defaultWidth;


// set the dimensions and margins of the graph
// const margin = {top: 20, right: 20, bottom: 20, left: 20},
//     width = wonHTMLPanel.width() - margin.left - margin.right,
//     height = defaultHeight * ratio - margin.top - margin.bottom;

// append the svg object to the body of the page
// const wonSvg = d3.select("#won-heatmap")
//     .append("svg")
...
// const lostSvg = d3.select("#lost-heatmap")
//     .append("svg")
//     .attr("width", width + margin.left + margin.right)
//     .attr("height", height + margin.top + margin.bottom)
//     .append("g")
